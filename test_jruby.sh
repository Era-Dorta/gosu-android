...
cd $GOSU_ANDROID_HOME

export GEM_HOME=$GOSU_ANDROID_HOME/tmp/gems
export GEM_PATH=$GEM_HOME
unset JRUBY_JARS_VERSION        # The version may vary across revisions
export GOSU_ANDROID_PLATFORM=FROM_GEM # Avoid the CURRENT setting since it ignores our GEM
bundle install
